...
export const reactQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Server Components можно использовать как Client Components, если пометить их директивой "use server"',
      'Разницы в производительности нет; отличие состоит только в расширении файлов компонентов',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Данные можно передавать только через внешние стейт-менеджеры вроде Zustand или Redux',
  ...
  },
  {
    ...
    options: [
      'Помечает компонент как React Server Component для выполнения на сервере',
      'Позволяет импортировать Node.js-модули напрямую в браузерный код',
      'Помечает функцию или модуль как Server Action, генерируя под капотом защищённую POST-endpoint (RPC) для вызова с клиента',
      'Инструктирует сборщик запускать весь файл внутри Web Worker на клиенте',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'use() должен вызываться строго внутри useEffect, вызывая ре-рендер после разрешения Promise',
      ...
      'use() является полной заменой async/await на сервере и не может быть запущен в Client Components',
      'use() перехватывает ошибки Promise и рендерит встроенный UI без использования Error Boundary',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'use(Context) работает только на сервере, а useContext — только в Client Components',
      'Разницы нет; use(Context) — это просто устаревший синоним для useContext',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Для компиляции React-компонентов в WebAssembly ради нативной производительности',
      'Для автоматической генерации TypeScript-типов на основе JSX разметки',
      ...
      'Для трансляции React-кода в чистые Web Components, работающие без библиотеки React',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он кэширует ответы API в localStorage для мгновенной загрузки при следующем визите',
      ...
      'Он ускоряет CSS-анимации за счёт предсказания движений курсора пользователя',
      'Он автоматически перезапускает упавшие сетевые запросы до 5 раз перед показом ошибки',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'useActionState используется в Server Components, а useFormStatus — только на клиенте',
      ...
      'useActionState является устаревшим хуком, заменённым на useFormStatus в стабильной версии React 19',
      'useActionState управляет вводом данных, а useFormStatus — валидацией полей формы',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Потому что React 19 запрещает использование более двух хуков в одном файле для оптимизации памяти',
      'Потому что хук возвращает Promise, который должен разрешаться только внутри дочерних элементов',
      'Вызывать можно, но только при условии передачи ссылки на форму через useRef в аргументы хука',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Предварительный рендеринг исключительно статических страниц, полностью исключающий динамические маршруты',
      'Сборка всего приложения в статичный HTML с последующей загрузкой динамического контента через iframe',
      ...
      'Возможность вручную выбирать, какие хуки React будут выполняться на сервере, а какие — на клиенте',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Использование изолированных iframe для изоляции стилей и скриптов React-компонентов',
      ...
      'Развёртывание каждого маршрута приложения на отдельном субдомене в виде микрофронтенда',
      'Компиляция всего кода в WebAssembly для минимизации использования JavaScript-движка',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Передача функций в качестве пропсов в Server Components',
      ...
      'Неправильная настройка утилит слияния CSS-классов вроде Tailwind CSS',
      'Использование TypeScript-интерфейсов, которые не поддерживаются браузером в рантайме',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Все запросы должны выполняться внутри хуков useEffect и useState на сервере',
      ...
      'Необходимо использовать специальный хук useFetch, доступный только в серверной среде',
      'RSC не поддерживают асинхронность; данные должны предварительно запрашиваться в Middleware',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он заменяет стандартную отправку формы на постоянное WebSocket-соединение',
      'Он автоматически сериализует все поля формы в JSON и отправляет их на указанный в action URL по умолчанию',
      ...
      'Он запрещает отправку формы до тех пор, пока поля не пройдут валидацию внешней AI-моделью',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Server Actions шифруют все передаваемые данные с помощью асимметричного сквозного шифрования',
      'Они полностью обходят правила CORS и политики безопасности браузера',
      'Они работают в изолированных iframe-контейнерах на клиенте',
  ...
  },
  {
    ...
    options: [
      'useTransition предназначен для задержки анимаций, а useDeferredValue — для задержки сетевых запросов',
      ...
      'useTransition выполняется на сервере, а useDeferredValue работает исключительно на клиенте',
      'Разницы нет; эти хуки абсолютно взаимозаменяемы во всех ситуациях',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Объединение происходит только при включённом строгом режиме React.StrictMode',
  ...
  },
  {
    ...
    options: [
      'Вызвать обновление состояния внутри хука useEffect',
      'Обернуть вызовы обновления состояния в функцию ReactDOM.flushSync()',
      'Передать состояние в виде инстанса Promise',
  ...
  },
  {
    ...
    options: [
      ...
      'createRoot требует компиляции всего приложения в WebAssembly для работы',
      'createRoot удаляет поддержку строгого режима StrictMode',
      'createRoot запрещает использование порталов (Portals) и серверной гидрации',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Стилистические сетки CSS, используемые React для выравнивания элементов',
      ...
      'Физические ядра процессора, на которые React распредерует процесс вычисления виртуального дерева',
      'Маршруты и пути в файловой системе Next.js App Router для разделения чанков',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он выполняет процесс вычисления VDOM внутри фонового Service Worker',
      ...
      'Он транслирует разметку напрямую в нативные GPU-команды',
      'Он полностью блокирует выполнение любого стороннего JavaScript на странице до завершения рендеринга',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Фаза компиляции (чистая) и фаза исполнения (с сайд-эффектами)',
      ...
      'Фаза Hydration (чистая на сервере) и фаза Mount (на клиенте)',
      'Фаза Creation (создание стейта) и фаза Update (обновление стейта)',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'React сравнивает только листовые текстовые узлы, игнорируя обертки',
      ...
      'React выполняет сравнение параллельно на множестве ядер процессора с помощью Web Workers',
      'Все узлы виртуального DOM кэшируются в постоянной памяти браузера',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Когда родительский компонент рендерится из-за обновления собственного состояния',
      ...
      'Когда компонент использует стили из внешних CSS-файлов',
      'Когда глубина вложенности дочерних элементов компонента превышает 10 уровней',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Suspense автоматически перехватывает любые JS-ошибки внутри дочерних компонентов',
      ...
      'Они являются взаимоисключающими; одновременное их использование в одной ветке дерева вызовет конфликт рендеринга',
      'ErrorBoundary отвечает за анимацию загрузки, а Suspense — за показ ошибок',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Это стриминг исходного кода приложения в браузер для последующей компиляции силами клиента',
      ...
      'Это протокол сжатия медиаданных для предотвращения задержек видеокомпонентов',
      'Это передача JSON-состояния на клиент перед началом сборки HTML',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он отправляет периодические фоновые HTTP-запросы для синхронизации данных',
      'Он отвечает за планирование cron-задач на сервере Node.js',
      ...
      'Он управляет расписанием роутинга в Next.js Middleware',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Хук отправляет асинхронный fetch-запрос с новым значением',
      'Хук мгновенно обновляет UI, но накладывает на изменённые элементы размывающий CSS-фильтр',
      ...
      'Хук искусственно задерживает вызов обновления на фиксированное время (аналог debounce)',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Проверить логи в консоли разработчика, которые генерируются автоматически',
      ...
      'Профайлер измеряет только время выполнения эффектов и не может отслеживать причины рендеров',
      'Посмотреть на вес JS-файлов во вкладке Network',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'React сохраняет DOM-узел, но стирает все его CSS-классы',
      ...
      'React игнорирует изменение ключа и проводит стандартное сравнение пропсов',
      'React выбрасывает ошибку компиляции в консоль браузера',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Zustand автоматически оборачивает все компоненты в React.memo',
      ...
      'Селекторы сохраняют состояние в URL, избавляя React от проверок',
      'Селекторы заставляют Zustand автоматически проводить глубокое сравнение всех полей объекта',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Атом, значение которого можно изменять только через серверные экшены',
      ...
      'Временный атом, удаляемый из памяти сразу после первого прочтения',
      'Атом, получающий свои данные непосредственно из URL-параметров страницы',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она группирует атомы в единую тему оформления сайта',
      ...
      'Это устаревшая функция, полностью заменённая на React Context',
      'Она преобразует набор атомов в срез состояния Redux Toolkit',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она автоматически настраивает интеграцию с базой данных MongoDB',
      ...
      'Она полностью избавляет от необходимости использовать Redux Middleware',
      'Она транспилирует Redux-срезы напрямую в React-компоненты',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'staleTime регулирует кэш на клиенте, а gcTime — на стороне сервера при работе с RSC',
      'staleTime измеряется исключительно в миллисекундах, а gcTime настраивается только в часах',
      'staleTime указывает частоту ре-рендеров компонента, а gcTime — частоту отправки сетевых запросов',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Замедлить сетевой запрос для ручного контроля анимации загрузки',
      'Записать данные в локальную базу данных и прекратить отправку на сервер',
      ...
      'Использовать хук useDeferredValue для откладывания обновления списков',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'SWR поддерживает только SSR, а TanStack Query — исключительно CSR-приложения',
      ...
      'SWR не имеет механизмов для проведения мутаций и оптимистичных обновлений',
      'TanStack Query лишен возможности автоматического перезапроса данных при фокусе окна',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'RHF использует аппаратное ускорение CSS-переходов для полей ввода',
      'RHF скомпилирована в WebAssembly, что ускоряет обработку событий браузера',
      ...
      'RHF не поддерживает динамическую валидацию, что снижает нагрузку на CPU',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она автоматически компилирует веб-формы в мобильные приложения React Native',
      'Она позволяет синхронно выполнять Zod-валидацию на сервере, а RHF-валидацию — на клиенте',
      ...
      'Она избавляет от необходимости писать HTML-атрибуты валидации (required, min, max)',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Только при создании небольших сайтов-визиток с минимумом интерактива',
      ...
      'Когда необходимо рендерить состояние исключительно в виде статичного HTML на сервере',
      'Когда требуется полностью исключить выполнение JavaScript в браузере клиента',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'RTK Query сохраняет ответы API в локальной базе данных Redis внутри браузера',
      ...
      'RTK Query удаляет кэш при каждом переходе по страницам для обеспечения актуальности данных',
      'Разработчик обязан вручную описывать логику сохранения кэша в useEffect',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Это селектор CSS, используемый для стилизации компонентов контекста',
      ...
      'Это паттерн, заменяющий Context Provider на классовый компонент-контроллер',
      'Это встроенное API в React 19, полностью заменяющее Zustand',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Написать кастомный useEffect в корневом компоненте для синхронизации',
      'Изменить глобальный мета-тег конфигурации веб-страницы',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Zustand не поддерживает вычисляемое состояние, требуя хранить все данные в готовом виде',
      ...
      'Zustand работает быстрее Redux за счёт отсутствия поддержки Middleware',
      'Вычисление производного состояния в Zustand требует обязательной компиляции через React Compiler',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она автоматически зашифровывает и выгружает стейт атома на удаленный сервер',
      ...
      'Она сжимает данные атомов в бинарный формат для экономии куки-файлов',
      'Она переводит стейт атома в режим "только для чтения", делая его неизменяемым',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Передать параметр имени вторым аргументом: import("./Component", { name: "my-chunk" })',
      'Использовать "магический комментарий" внутри импорта: import(/* webpackChunkName: "my-custom-chunk" */ "./Component")',
      'Именование чанков возможно только при использовании конфигурации Next.js маршрутов',
      'Дать экспортируемому компоненту имя с особым префиксом _chunk',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он настраивает масштаб отображения виртуализированных элементов',
      ...
      'Он заставляет элементы списка рендериться в виде статического HTML без использования JS',
      'Он регулирует максимальный размер кэша для сетевых ответов списка',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Когда компонент импортируется динамически с использованием React.lazy',
      'Когда компонент написан в виде классового компонента',
      'Только если глубина вложенности компонентов превышает 10 уровней',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Оно указывает, какие сторонние пакеты имеют право использовать localStorage',
      'Оно помечает пакет как асинхронный для загрузки через Web Workers',
      ...
      'Оно включает логирование сетевых запросов на стороне сервера',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Это способ обмена CSS-in-JS стилями между разными вкладками браузера',
      ...
      'Это модуль перевода интерфейса для интернационализации в Next.js',
      'Это защищенный протокол передачи состояния Redux по веб-сокетам',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она сохраняет скомпилированные файлы во внутреннем хранилище IndexedDB в браузере',
      ...
      'Она выполняет сборку Webpack внутри серверного middleware во время запроса',
      'Она компилирует код напрямую в бессерверные облачные функции',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Unit-тесты пишутся на чистом JS, а интеграционные — только на TS или Bash',
      ...
      'Unit-тесты запускаются в реальном браузере, а интеграционные — только в консоли Node.js с JSDOM',
      'Разницы нет; это разные названия для одних и тех же тестовых сценариев',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Потому что userEvent работает быстрее и не требует импорта функции act()',
      'Потому что userEvent функционирует без JSDOM, позволяя запускать тесты в чистой консоли Node.js',
      ...
      'Потому что userEvent — это новое API, поддерживающее исключительно React 19',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она указывает компилятору собрать тестовый код в продакшн-формат',
      'Она объявляет тест асинхронным',
      ...
      'Она используется исключительно для моканья сетевых запросов внутри тестов',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'MSW запускает локальный прокси-сервер Node.js, перенаправляющий весь системный трафик ОС',
      ...
      'MSW переопределяет компилятор JavaScript на этапе сборки для замены импортов fetch',
      'MSW представляет собой расширение для Chrome, которое необходимо устанавливать локально',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Playwright поддерживает тестирование только Server Components, в то время как Cypress — только Client Components',
      'Cypress тестирует исключительно JavaScript-код, а Playwright ориентирован строго на TypeScript',
      'Cypress выполняет тесты на стороне сервера, а Playwright запускает их внутри JSDOM',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Vitest запускает тесты внутри нативного симулятора мобильных устройств iOS/Android',
      'Vitest полностью избавляет от необходимости писать проверочные утверждения (assertions)',
      ...
      'Vitest не поддерживает JSDOM и тестирование компонентов, содержащих HTML-разметку',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Оно сравнивает скриншоты компонентов на разных размерах экранов для поиска визуальных багов',
      ...
      'Оно проверяет корректность drag-and-drop перетаскивания элементов внутри интерфейса Storybook',
      'Оно автоматически генерирует unit-тесты для Jest, анализируя CSS-файлы проекта',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Всегда искать элементы с помощью container.querySelector(".class-name") по именам CSS-классов',
      'Использовать getByTestId в качестве основного и единственного метода поиска',
      ...
      'Искать элементы исключительно по текстовому содержимому методом getByText',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Утилита act() не была найдена в глобальной области видимости Node.js',
      ...
      'Компонент был скомпилирован в режиме разработки вместо продакшна',
      'Тест попытался несанкционированно перезаписать файлы куки в браузере',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Установить CSS-свойство outline: none на всех интерактивных элементах внутри модалки',
      ...
      'Браузер по умолчанию берёт на себя управление фокусом модальных окон без участия JavaScript',
      'Циклически вызывать метод focus() на контейнере модального окна каждые 100 миллисекунд через setInterval',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Compile-time библиотеки требуют писать стили в отдельных CSS-файлах, запрещая использование JS-кода',
      ...
      'Zero-runtime CSS-in-JS решения принципиально не поддерживают динамическую смену тем оформления',
      'Runtime-библиотеки компилируют стили в нативные стили мобильных платформ вместо HTML-классов',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Она автоматически транслирует классы Tailwind в формат styled-components',
      'Она удаляет дублирующиеся имена классов, но не умеет разрешать конфликты между классами, отвечающими за одно CSS-свойство',
      ...
      'Она отправляет строку классов на сервер для динамической генерации нового CSS-файла',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Он используется для анимации сложных путей и графики внутри тега `<canvas>`',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'dnd-kit не использует виртуальный DOM React для рендеринга перетаскиваемых элементов',
      ...
      'react-dnd предназначена исключительно для серверной среды и Node.js',
      'dnd-kit автоматически сохраняет координаты перетаскиваемых элементов в куки пользователя',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Это нативный фреймворк iOS для отображения векторных иконок приложений',
      ...
      'Это модуль базы данных, используемый для выполнения локальных SQLite-запросов',
      'Это сервис автоматической выгрузки готовых сборок в App Store и Google Play',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Pages Router поддерживает вложенные макеты "из коробки" без лишних ре-рендеров, в отличие от App Router',
      ...
      'Pages Router полностью запрещает использование клиентского рендеринга внутри макетов',
      'App Router требует статической компиляции всего проекта и не поддерживает динамический SSR',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Оно выполняется на клиенте внутри Service Worker для перехвата запросов к медиа-ресурсам',
      ...
      'Это Node.js-скрипт, собирающий CSS-стили на этапе деплоя приложения',
      'Это прослойка базы данных для прямой привязки моделей Next.js к Prisma ORM',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Это вспомогательные компоненты для настройки стилей макетов, заменившие Sass',
      ...
      'Это клиентские хуки, отвечающие за предвыборку (prefetching) путей в компонентах Link',
      'Это конфигурации Webpack для разделения кодовой базы на чанки',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Они компилируют шрифты и картинки в base64-строки и внедряют их прямо в JS-код',
      ...
      'Они являются стандартными CSS-файлами стилей без какой-либо логики оптимизации сборщика',
      'Они налету сжимают графику с помощью алгоритмов WebAssembly на стороне клиента',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Remix принципиально не поддерживает отправку POST-запросов средствами HTML-форм',
      ...
      'Next.js поддерживает только статичные страницы, а Remix — исключительно клиентский SPA-рендеринг',
      'Remix компилирует всё приложение в один универсальный Server Action',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Astro упаковывает все React-компоненты в один файл и запускает их в фоновом режиме через Web Worker',
      ...
      'Директивы представляют собой свойства CSS, заставляющие компоненты плавать поверх других окон',
      'Astro компилирует React-компоненты в нативные теги iframe',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Паттерн, при котором один компонент содержит внутри себя более 50 переменных состояния',
      ...
      'Паттерн, форсирующий сборку React-компонентов из чистых браузерных Web Components',
      'Макетный паттерн, оборачивающий элементы в несколько слоёв CSS Grid сеток',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Использовать тип any для всех входящих пропсов компонента',
      ...
      'Generic-компоненты не поддерживаются в экосистеме React и заменяются на Portals',
      'Скомпилировать TypeScript-файлы в JSON-формат перед выполнением в браузере',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Паттерн передачи компонентов в виде текстовых строк, замененный впоследствии синтаксисом JSX',
      ...
      'Оптимизационный паттерн для ускорения парсинга внешних CSS-стилей',
      'Специфичная особенность классовых компонентов, полностью удаленная в React 16',
    ],
    correctAnswer: 1,
    explanation:
