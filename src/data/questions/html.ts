...
export const htmlQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Разницы нет, оба метода работают абсолютно одинаково во всех сценариях',
      'cloneNode возвращает копию, которая сохраняет живую связь с оригинальным шаблоном, а importNode создает независимый узел',
      'cloneNode не копирует вложенные обработчики событий, тогда как importNode импортирует их вместе с узлами'
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Метод registerAttributes(), перечисляющий нужные атрибуты',
  ...
  },
  {
    ...
    options: [
      'Когда элемент успешно клонируется с помощью cloneNode',
      'Когда элемент переносится в новый документ (например, из iframe в основной документ через document.adoptNode)',
      'Когда элемент переходит из состояния "unresolved" в состояние "defined"',
      'Когда дочерние элементы Shadow DOM перераспределяются между слотами'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Стили автоматически компилируются в нативный CSS-код с поддержкой Sass-синтаксиса',
      ...
      'Он автоматически изолирует стили глобального документа от стилей компонента в двустороннем порядке',
      'Позволяет использовать CSS-переменные без ограничений на наследование'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он позволяет осуществлять переходы между разными доменами без перезагрузки страницы',
      ...
      'Он автоматически кэширует HTML-страницы на стороне клиента',
      'Он полностью заменяет Service Worker в части кэширования сетевых запросов'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Через тег <link rel="speculation" href="...">'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Объект Color с RGBA и HSLA значениями',
      'Объект с единственным свойством sRGBHex, содержащим строку цвета в формате HEX (например, "#ff0000")',
      'Объект ImageData, содержащий пиксели области клика',
      'Строку с HEX-кодом цвета'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он открывается автоматически при загрузке страницы без действий пользователя',
      'Он позиционируется автоматически в центре экрана и блокирует весь остальной интерфейс как модальное окно',
      ...
      'Он отображается только на мобильных устройствах, а на десктопах скрывается'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'show() показывает диалог по центру экрана, а showModal() — в левом верхнем углу',
      ...
      'showModal() поддерживает закрытие по клавише Escape, а show() — нет',
      'show() используется только для кастомных всплывающих подсказок, а showModal() — только для форм с отправкой данных'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Псевдокласс :open на самом элементе <details>',
      'Псевдоэлемент ::summary-body',
      'Псевдокласс :expanding'
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      '<meter> используется только для числовых полей ввода, а <progress> — для вывода результатов',
      ...
      'Они идентичны, но <meter> поддерживается только в старых браузерах',
      '<meter> используется для измерения времени, а <progress> — для любых других величин'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Для вывода системных логов консоли браузера на страницу',
      'Для отображения результатов вычислений или действий пользователя (например, расчёт в калькуляторе формы)',
      'Для ленивой загрузки внешних текстовых файлов',
      'Для форматирования вывода кода программ'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Вложить input внутрь элемента datalist',
  ...
  },
  {
    ...
    options: [
      'Она автоматически фокусит первое поле ввода при загрузке страницы',
      ...
      'Она предотвращает отправку невалидных полей на сервер',
      'Она убирает необходимость использовать атрибуты aria-label и placeholder'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'checkValidity() отправляет данные формы на сервер для валидации, а reportValidity() валидирует на клиенте',
      ...
      'reportValidity() работает асинхронно, возвращая Promise, а checkValidity() работает синхронно',
      'checkValidity() проверяет только JS-валидацию, а reportValidity() — встроенные HTML-атрибуты'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Форма перестает быть доступной для отправки',
      ...
      'Все поля ввода внутри формы становятся необязательными (required игнорируется на уровне DOM)',
      'Браузер прекращает отправку cookies вместе с запросом формы'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'type="number" включает автозаполнение, а inputmode="numeric" отключает его',
      'type="number" меняет тип данных в JS на number, а inputmode="numeric" сохраняет string',
      ...
      'Разницы нет, это старый и новый синтаксис одного и того же свойства'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Для настройки текста подсказки, всплывающего при наведении на клавишу Enter',
      ...
      'Для перехвата нажатия Enter в JavaScript',
      'Для управления фокусом при нажатии Enter'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Атрибут не наследуется, его нужно объявлять на каждом конкретном текстовом элементе',
      ...
      'Он наследуется только элементами форм, но не обычными div с contenteditable',
      'Он наследуется только если родителю задано значение spellcheck="default"'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'until-found скрывает элемент только до тех пор, пока страница полностью не загрузится',
      'until-found скрывает элемент от обычных пользователей, но оставляет доступным для скринридеров',
      ...
      'until-found скрывает элемент только на мобильных экранах'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Элемент становится невидимым, но сохраняет свои размеры в документе',
      'Браузер игрирует элемент при индексации поисковыми роботами',
      ...
      'Элемент замораживает выполнение всех асинхронных JS-скриптов внутри себя'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Для блокировки выполнения JS до тех пор, пока CSS полностью не загрузится',
      ...
      'Для предотвращения отправки запросов к сторонним доменам',
      'Для блокировки взаимодействия пользователя с интерфейсом во время загрузки'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Браузер проигнорирует fetchpriority для изображений, приоритет всегда определяет сам браузер',
      ...
      'Изображение будет заблокировано до полной загрузки всех JS-модулей',
      'Браузер загрузит изображение только после события DOMContentLoaded'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'modulepreload автоматически выполняет (execute) код модуля сразу после его скачивания',
      ...
      'modulepreload шифрует код модуля для предотвращения XSS',
      'modulepreload позволяет загружать модули только по протоколу HTTP/3'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Сжатие HTML-кода для уменьшения размера страницы',
      'Преобразование HTML-разметки в Markdown-формат',
      ...
      'Валидацию синтаксиса HTML-кода на соответствие стандартам W3C'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Он блокирует все запросы к сторонним API, не имеющим HTTPS',
      'Он заменяет стандартные методы DOM-манипуляций на шифрованные версии',
      ...
      'Он автоматически генерирует CSP заголовки для каждой сессии'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Document PiP работает только с текстовыми документами в формате PDF',
      ...
      'Document PiP не требует взаимодействия с пользователем для открытия окна',
      'Document PiP поддерживается только на мобильных операционных системах'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Чтобы отключить автозаполнение паролей внутри фрейма',
      ...
      'Чтобы скрыть IP-адрес клиента от сервера, отдающего iframe',
      'Чтобы запустить iframe без поддержки HTTPS'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Для генерации PDF-отчетов о посещаемости сайта',
      'Для автоматической отправки отчетов об ошибках JS на почту разработчику',
      ...
      'Для тестирования производительности рендеринга'
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Любой сетевой запрос, занимающий более 500 миллисекунд',
      'Задача в основном потоке (Main Thread), выполнение которой занимает более 50 миллисекунд',
      'Отрисовка кадра, занимающая более 16.6 миллисекунд',
      'Скрипт, размер которого превышает 1 мегабайт'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Путем сравнения размеров DOM-дерева до и после скролла',
      'С помощью PerformanceObserver, настроенного на отслеживание записей типа "layout-shift"',
      'Через вызов метода performance.getLayoutShifts()',
      'С помощью отслеживания события resize на окне'
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'performance.start(); // код; performance.stop();',
      'console.time("start"); // код; console.timeEnd("end");',
  ...
  },
  {
    ...
    options: [
      'Он работает по протоколу HTTP/1.1 и поддерживается старыми браузерами',
      ...
      'Он автоматически шифрует данные на уровне прикладного ПО без использования SSL/TLS',
      'Он позволяет передавать данные без участия веб-сервера (P2P)'
    ],
    correctAnswer: 1,
    explanation:
